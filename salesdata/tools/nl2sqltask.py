...
def getnl2sqlQuery(query_input):
    ...
    sql_agent = Agent(
        ...
        goal="Convert natural language queries into precise S   QL queries for the sales_data table, ensuring accurate and efficient querying.",
        backstory = (
            "I am an AI assistant skilled in transforming natural language queries into structured SQL statements, specifically "
            "designed to work with the 'sales_data' and 'product_data' tables. I understand the structure of these tables, "
